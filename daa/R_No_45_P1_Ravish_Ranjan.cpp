...
int main(){
    ...
    // first question
    Analyzer analyzer1("float,firstName","age,name",is,"SortOnAge");
    analyzer1.analyze(0,"InsertionSortOnAge"); // insertion sorting data on age 
    
    // second question
    Analyzer analyzer2("float,firstName","age,name",is,"SortOnName");
    analyzer2.analyze(1,"InsertionSortOnName"); // insertion sorting data on name
    
    // third question (with persistent data)
    Analyzer analyzer3("float,firstName","age,name",is,"SortOnAgeThenName",true);
